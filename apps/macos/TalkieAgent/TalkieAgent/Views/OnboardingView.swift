...
enum OnboardingStep: Int, CaseIterable {
    ...
    case engineSetup = 2      // Introduce Talkie Agent as menu bar app
...
final class OnboardingManager: ObservableObject {
    ...
    func performStatusCheck() async {
        ...
        warmupStatusMessage = "Connecting to embedded engine..."
...
// MARK: - Talkie Agent Intro Step (Menu Bar App)
