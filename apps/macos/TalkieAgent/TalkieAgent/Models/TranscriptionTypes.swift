...
public struct TranscriptionRequest {
    ...
    public let postProcess: PostProcessOption  // Post-processing to apply after transcription

    public init(audioPath: String, languageHint: String? = nil, isLive: Bool = false, externalRefId: String? = nil, postProcess: PostProcessOption = .dictionary) {
...
public struct Transcript {
    ...
    public let timedTranscription: TimedTranscription?

    public init(text: String, confidence: Float? = nil, timedTranscription: TimedTranscription? = nil) {
        self.text = text
        self.confidence = confidence
        self.timedTranscription = timedTranscription
    }
}
