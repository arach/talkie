#!/bin/bash
# Generate TalkieAgent app icons with chrome bezel effect
# Usage: ./generate_icons.sh <source_image.png>

SOURCE="${1:-/tmp/icon_source_square.png}"
DEST="$(dirname "$0")/../TalkieAgent/Assets.xcassets/AppIcon.appiconset"
...
echo "Generating TalkieAgent icons from: $SOURCE"
