...
enum AppScreen: String, CaseIterable, Identifiable, Codable {
    ...
    var sourceFiles: [String] {
        switch self {
        case .homeDashboard: return ["Views/HomeScreen.swift"]  // Was TalkieHomeView (deleted)
        case .homeUnified: return ["Views/HomeScreen.swift"]
        ...
        case .liveMain: return ["Views/Live/DictationsScreen.swift"]
        case .liveHistory: return ["Views/Live/History/HistoryView.swift"]
        case .memosAllMemos: return ["Views/Memos/MemosScreen.swift"]
        case .memoDetail: return ["Views/TalkieObject/TalkieView.swift", "Views/TalkieObject/Sections/TOSharedComponents.swift"]
        case .memoEditor: return ["Views/TalkieObject/TalkieView.swift"]
...
class DesignAuditor {
    ...
    private var basePath: String {
        ...
        // Navigate up from Debug/DesignAuditor.swift to apps/macos/Talkie/
    ...
    nonisolated func getGitBranch() -> String? {
        let devPaths = Self.gitLookupPaths()
    ...
    private nonisolated static func gitLookupPaths() -> [String] {
        [
            ProcessInfo.processInfo.environment["TALKIE_REPO_ROOT"],
