...
//  Talkie macOS
//
//  Displays the embedded engine status and logs.
//  The embedded engine runs inside TalkieAgent and handles local transcription.
//
...
struct TalkieServiceMonitorView: View {
    ...
    private var header: some View {
        HStack(spacing: Spacing.sm) {
            ...
            .buttonStyle(.plain)
            .help("Open TalkieAgent.app in Finder")
    ...
    private func openInFinder() {
        // Open the TalkieAgent bundle that hosts the embedded engine when available.
        if let appPath = ServiceManager.shared.live.bundlePath,
