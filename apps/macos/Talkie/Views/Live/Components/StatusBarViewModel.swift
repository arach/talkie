...
final class StatusBarViewModel {
    ...
    @ObservationIgnored private let liveMonitor: AgentServiceState
    ...
    @ObservationIgnored private let liveSettings: AgentSettings
    ...
    @MainActor
    init(
        liveMonitor: AgentServiceState? = nil,
        ...
        liveSettings: AgentSettings? = nil
    ) {
