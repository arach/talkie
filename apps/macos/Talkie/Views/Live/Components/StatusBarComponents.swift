...
struct LiveOfflineIcon: View {
    ...
    var body: some View {
        ...
        .help("Agent Mode is inactive. Click to enable.")
    }
}
...
struct LiveEnvironmentBadge: View {
    ...
    var body: some View {
        Text(badgeText)
            ...
            .onHover { isHovered = $0 }
            .help("Talkie Agent: \(environment.displayName)")
    }
}
...
extension Notification.Name {
    ...
    static let switchToAgentSettingsAudio = Notification.Name("switchToAgentSettingsAudio")
    static let switchToAgentSettingsTranscription = Notification.Name("switchToAgentSettingsTranscription")
    static let switchToAgentSettingsOverview = Notification.Name("switchToAgentSettingsOverview")

    @available(*, deprecated, renamed: "switchToAgentSettingsAudio")
    static let switchToLiveSettingsAudio = switchToAgentSettingsAudio
    @available(*, deprecated, renamed: "switchToAgentSettingsTranscription")
    static let switchToLiveSettingsTranscription = switchToAgentSettingsTranscription
    @available(*, deprecated, renamed: "switchToAgentSettingsOverview")
    static let switchToLiveSettingsOverview = switchToAgentSettingsOverview
}
