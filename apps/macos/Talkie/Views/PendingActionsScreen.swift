...
struct PendingActionsScreen: View {
    ...
    private func retryAction(_ action: RecentAction) {
        ...
        Task {
            do {
                ...
                _ = try await WorkflowExecutor.shared.retryWorkflow(
                    workflowId: workflowId,
                    memoId: memoId,
                    fallbackWorkflowName: action.workflowName
                )
            } catch {
...
typealias PendingActionsView = PendingActionsScreen
