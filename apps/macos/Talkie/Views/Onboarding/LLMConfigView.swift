...
/// Deprecated: This view is no longer part of the onboarding flow.
/// LLM configuration is available in Settings → AI Models.
struct LLMConfigView: View {
    let onNext: () -> Void
    @Environment(\.colorScheme) private var colorScheme
    @State private var isPulsing = false
    @State private var selectedModelRaw: String? = nil
    ...
    private var selectedModel: LocalAIModel? {
        get {
            guard let rawValue = selectedModelRaw else { return nil }
