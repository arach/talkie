        ...
        mode: .console(
            ConsoleConfig(
                lines: [
                    ...
                    ConsoleLine(timestamp: "[4:37:48 PM]", icon: "→", text: "Checking speech model availability (Whisper/Parakeet)...", delay: 1.0),
                    ConsoleLine(timestamp: "[4:37:48 PM]", icon: "→", text: "Optimizing on-device audio pipeline...", delay: 1.2),
