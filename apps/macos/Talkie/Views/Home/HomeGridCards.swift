...
struct HomeStatCard: HomeCard {
    ...
    init(cardType: HomeCardType, icon: String, value: String, label: String, detail: String?) {
...
private struct SetupItem: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .padding(.vertical, 6)
            .padding(.horizontal, 6)
            .background(HomeHoverChrome(style: .standardRow(cornerRadius: CornerRadius.xs)))
        }
        .buttonStyle(.plain)
    }
}
