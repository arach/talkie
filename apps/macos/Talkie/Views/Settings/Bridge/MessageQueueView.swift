...
struct MessageQueueView: View {
    ...
    private func sendToTalkieAgent(_ message: QueuedMessage) {
        ...
        Task {
            do {
                ...
                guard let xpcManager = ServiceManager.shared.live.xpcManager else {
                    throw NSError(domain: "MessageQueue", code: 1, userInfo: [NSLocalizedDescriptionKey: "Talkie Agent not connected"])
                }
