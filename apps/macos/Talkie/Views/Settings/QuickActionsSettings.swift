    ...
    var body: some View {
        SettingsPageContainer {
                SettingsPageHeader(
                    icon: "bolt",
                    title: "QUICK ACTIONS",
                    subtitle: "Pin workflows to show them as quick actions when viewing a memo. Pinned workflows sync to iOS via iCloud and are backed by workflows/config.json."
                )
        } content: {
