...
// Note: This view is also gated by FeatureFlags.showConnectionCenter in SettingsColumns
...
// Note: Similar enum exists in apps/ios/Talkie iOS/Views/ConnectionCenterView.swift
...
struct ConnectionCenterView: View {
    ...
    private func status(for type: ConnectionType) -> ConnectionRowStatus {
        ...
        case .iCloud:
            // Check CloudKit status from the declarative settings store
