...
//
//  Replaces XPC-based TalkieAgent communication with clean URL notifications.
//
//  Usage:
...
enum RouteScope: String, CaseIterable {
    ...
    case live     // Agent helper → Talkie internal sync (legacy case name)
    case system   // Navigation, lifecycle, UI commands

    static var agent: RouteScope { .live }

    var displayName: String {
        switch self {
        case .app: return "App Shortcuts"
        case .live: return "Agent Sync"
