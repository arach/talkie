...
shortcuts:
  ...
  - { chord: "⌃⌥⇧⌘P", action: "Paste last screenshot",     default: true }
...
agent_facts:
  ...
  - "Hyper+T toggles the Tray Shelf; Hyper+5 opens the Tray Viewer."
...
- Direct capture chords use **Hyper+3** / **Hyper+4** / **Hyper+6** for
  fullscreen, region, and window respectively, and the result lands in
  the shelf either way.
- **Hyper+P** pastes the most recent screenshot wherever the cursor is.
...
The **Shelf** is the lightweight strip. The **Viewer** (Hyper+5) is the
