...
/// Common interface for STT models and voice providers.
/// Enables generic UI components like ModelCard to work with both.
public protocol ModelItem: Identifiable, Sendable {
    /// Unique identifier (e.g., "whisper:openai_whisper-small", "system:samantha")
    var id: String { get }

    /// Human-readable name (e.g., "Whisper Small", "Samantha")
    ...
    /// Provider/family (whisper, parakeet, elevenlabs, etc.)
