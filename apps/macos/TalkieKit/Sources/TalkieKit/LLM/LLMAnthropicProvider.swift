//
//  LLMAnthropicProvider.swift
//  TalkieKit
//
//  Anthropic Claude API provider for LLM generation
//

import Foundation

public final class LLMAnthropicProvider: LLMProvider, @unchecked Sendable {
    ...
    public var isAvailable: Bool {
        get async {
            LLMAPIKeyStore.shared.get(.anthropic) != nil
        }
    }
    ...
    public func generate(
        ...
        guard let apiKey = LLMAPIKeyStore.shared.get(.anthropic) else {
