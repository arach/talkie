...
// Note: This view is also gated by FeatureFlags.showConnectionCenter in SettingsView
...
// Note: Keep in sync with apps/macos/Talkie/Views/Settings/ConnectionCenterView.swift
    ...
    var body: some View {
        Group {
            if type == .macBridge {
                ...
                .accessibilityIdentifier("connection.macBridge")
            } else {
