...
struct TranscriptEngines {
    static let appleSpeech = "apple_speech"      // Legacy: SFSpeechRecognizer transcripts
    static let speechAnalyzer = "speech_analyzer" // SpeechAnalyzer (current)
    ...
    /// Returns the best available iOS engine for this device
    static var bestIOSEngine: String {
        speechAnalyzer
    }
