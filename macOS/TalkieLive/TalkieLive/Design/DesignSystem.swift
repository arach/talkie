...
//  TalkieLive
//
//  Design tokens for TalkieLive.
//  Spacing and CornerRadius come from TalkieKit for consistency.
//

import SwiftUI
import TalkieKit

// MARK: - Shared Tokens (from TalkieKit)

/// Use TalkieKit.Spacing directly - single source of truth
typealias Spacing = TalkieKit.Spacing

/// Use TalkieKit.CornerRadius directly - single source of truth
