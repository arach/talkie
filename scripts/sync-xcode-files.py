...
Skips: build/, .build/, DerivedData/, packages/swift/, .swiftpm/, xcshareddata/
"""
...
PROJECTS = {
    'macos': {
        'source_dir': REPO_ROOT / 'apps' / 'macos' / 'Talkie',
        'pbxproj': REPO_ROOT / 'apps' / 'macos' / 'Talkie' / 'Talkie.xcodeproj' / 'project.pbxproj',
        'skip_dirs': {'build', '.build', 'DerivedData', 'Packages', '.swiftpm', 'xcshareddata'},
        'source_group': None,  # Use mainGroup
    },
    'ios': {
        'source_dir': REPO_ROOT / 'apps' / 'ios' / 'Talkie iOS',
        'pbxproj': REPO_ROOT / 'apps' / 'ios' / 'Talkie-iOS.xcodeproj' / 'project.pbxproj',
        'skip_dirs': {'build', '.build', 'DerivedData', 'Packages', '.swiftpm', 'xcshareddata'},
        'source_group': None,  # Use mainGroup
    },
    'live': {
        'source_dir': REPO_ROOT / 'apps' / 'macos' / 'TalkieAgent' / 'TalkieAgent',
        'pbxproj': REPO_ROOT / 'apps' / 'macos' / 'TalkieAgent' / 'TalkieAgent.xcodeproj' / 'project.pbxproj',
        'skip_dirs': {'build', '.build', 'DerivedData', 'Packages', '.swiftpm', 'xcshareddata'},
        'source_group': None,
    },
}
