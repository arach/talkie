...
export const SERVICES: TalkieService[] = [
  {
    ...
    appName: "Talkie.app",
    logSubsystem: "to.talkie.app.mac",
  ...
  },
  {
    name: "TalkieAgent",
    aliases: ["agent"],
    devBundleId: "to.talkie.agent.dev",
    prodBundleId: "to.talkie.agent",
    launchdLabel: "to.talkie.agent.xpc.dev",
    machServices: ["to.talkie.agent.xpc.dev"],
    bridgePort: null,
    xcodeWorkspace: null,
  ...
  },
  {
    name: "TalkieSync",
    aliases: ["sync"],
    devBundleId: "to.talkie.app.sync.dev",
    prodBundleId: "to.talkie.app.sync",
    launchdLabel: "to.talkie.app.sync.xpc.dev",
    machServices: ["to.talkie.app.sync.xpc.dev"],
    bridgePort: 19820,
    xcodeWorkspace: null,
    ...
    logSubsystem: "to.talkie.app.sync",
    sourceDir: null,
    defaultLaunch: false,
  },
  {
    name: "TalkieRunner",
    aliases: ["runner"],
    devBundleId: "to.talkie.app.runner",
    prodBundleId: null,
    launchdLabel: null,
    machServices: null,
    bridgePort: null,
    xcodeWorkspace: null,
    xcodeProject: "tools/talkie-runner/TalkieRunner.xcodeproj",
    xcodeScheme: "TalkieRunner",
    derivedDataPrefix: "TalkieRunner-",
    preferredDerivedDataPrefix: null,
    appName: "TalkieRunner.app",
    logSubsystem: "to.talkie.app.runner",
    sourceDir: "tools/talkie-runner",
    defaultLaunch: false,
  },
];
