...
const SURFACES: Surface[] = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        tracking: 0.6,
        uppercase: true,
        usage: "Section header (post-tweak)",
      },
      {
  ...
  {
    name: "Capture HUD (PEARL · SLATE · AMBER)",
    file: "Services/Capture/CaptureHUDPanel.swift",
    blurb:
      "Top-center floating chord menu, themed by wallpaper luminance. All-uppercase eyebrows; tight monospaced key chips.",
    rows: [
      {
        sample: "↵ CAPTURE · ⎋ DISMISS",
        size: 9,
        weight: "regular",
        tracking: 1.6,
        uppercase: true,
        usage: "Top-strip hint",
      },
      {
        sample: "SCREENSHOT",
        size: 9,
      ...
      },
      {
        ...
        tracking: 0.9,
        uppercase: true,
        usage: "Bottom-strip extra label",
      },
    ],
  },
  {
    ...
    blurb:
      "Older Hyper-chord bar — pill mode tabs, A/S/D chord keys with suffix labels. Still in the codebase.",
    rows: [
      {
        sample: "Screenshot",
        size: 11,
      ...
      },
      {
        ...
        weight: "bold",
        design: "monospaced",
        usage: "Extra key letter (C / N / F / W)",
      },
      {
        sample: "3",
        size: 10,
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        size: 10,
        weight: "regular",
        usage: "List row app name / context",
      },
      {
        sample: "1440×900",
        size: 9,
      ...
      },
      {
        ...
        weight: "regular",
        design: "monospaced",
        usage: "Detail preview dimensions",
      },
      {
        sample: "Region",
        size: 10,
