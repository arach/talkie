...
export const STUDIO_PAGES: StudioPage[] = [
  ...
  },
  {
    ...
    label: "Library · No Selection",
    bucket: "surfaces",
    platform: "mac",
    family: "library",
    status: "wip",
    swift: ["apps/macos/Talkie/Views/Library/ScopeLibraryEmptyState.swift"],
    blurb: "No-selection pane reframed — stop reprinting the rail. Overview digest / Mosaic / Featured + a true zero-state, instead of a second list.",
  },
  {
    href: "/mac-library-day",
    label: "Library · Day",
    bucket: "surfaces",
    platform: "mac",
    family: "library",
    status: "concept",
    swift: ["apps/macos/Talkie/Views/Library/ScopeLibraryEmptyState.swift"],
    blurb: "No-selection day digest on a captures-heavy day — real thumbnails replace the placeholder glyph. Filmstrip / Contact / Grouped variants.",
  },
  {
  ...
  {
    href: "/mac-markup-dock",
    label: "Markup Dock",
    bucket: "surfaces",
    platform: "mac",
    family: "capture",
    status: "concept",
    blurb: "Level-up of the floating overlay tool cluster (shared by live-recording markup + the desktop ink layer) · variant board over light/dark/photo backdrops · real line-art icons replace the unicode glyphs. Ports to overlay.css + overlay.html.",
  },
  {
  ...
  {
    href: "/mac-share-export",
    label: "Share Export",
    bucket: "surfaces",
    platform: "mac",
    family: "capture",
    status: "concept",
    blurb: "TLK-032 V1 · screenshot export panel · preview + inspector · Original/Polished presets · Copy/Save As · no video/cards/Private.",
    swift: [
      "apps/macos/Talkie/Views/Notes/ScopeCaptureDetailView.swift",
  ...
  {
    href: "/mac-agent-home-shell",
    label: "Agent Home (Shell)",
    bucket: "surfaces",
    platform: "mac",
    family: "agent",
    status: "wip",
  ...
  },
  {
    ...
    blurb: "Better starting point for the iPhone home — fixes the 3×TODAY stat strip, edge-to-edge squish, and the dead empty-state. Current vs redesign, empty + populated, in Scope.",
  },
  {
    href: "/ios-home-recents",
    label: "Home · Recents",
    bucket: "surfaces",
    platform: "iphone",
    family: "home",
    status: "wip",
    swift: ["apps/ios/Talkie iOS/Views/Next/HomeNextView.swift"],
    blurb: "Stress case for the Home recent card: ten compact rows plus load-more footer, with no stretched final row.",
  },
  {
    href: "/library",
    label: "Library",
