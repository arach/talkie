...
const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    items: [
      { code: "S01", title: "Accessibility audit", detail: "Phase A · VoiceOver labels. Phase B · Dynamic Type scaling. Phase C · ThemeContrastDebugNext inspector + acted on failures: Ghost (light A0A0A0 → 8A8A8A, dark 5A5A5A → 7A7A7A), Lift (light A0A0A0 → 8A8A8A), Scope (light A39989 → 8A7E6C). All textTertiary now passes WCAG large-text 3:1. Borderline 4.5:1 normal-text cases preserved for visual hierarchy.", status: "shipped", size: "l" },
