...
struct TalkieApp: Identifiable {
    ...
    static let all: [TalkieApp] = [
        ...
        TalkieApp(
            ...
            launchAgentPlist: "jdi.talkie.agent.xpc.dev.plist",
            prodLaunchAgentLabel: "jdi.talkie.agent",
        ...
        TalkieApp(
            ...
            name: "TalkieHeadless",
            icon: "server.rack",
            devBundleID: "jdi.talkie.headless",
            prodBundleID: nil,
...
class AppState {
    ...
    func launch(_ app: TalkieApp, environment: AppEnvironment, debugMode: Bool = false) {
        ...
        if isRunning(app, environment: oppositeEnv) {
            ...
            // Also kill any stale processes with the same name from old builds
