...
TalkieAgent is a background helper app that provides:
...
- **XPC Broadcast:** State changes broadcast to Talkie via `TalkieAgentXPCService`
...
**Discussion:**
- Implements `TalkieAgentXPCServiceProtocol` from TalkieKit
- Allows Talkie to:
