...
`apps/macos/Talkie/Views/` - SwiftUI view components (85 files, 43,644 lines)
...
Multi-modal navigation hub for TalkieAgent:
...
- Process management (TalkieEngine/TalkieAgent)
