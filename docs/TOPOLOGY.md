...
| **TalkieAgent** | launchd (`jdi.talkie.agent.dev`) | Always-on (KeepAlive) | Mic, keyboard injection, in-process transcription (Parakeet/Whisper) |
...
| Mach | `jdi.talkie.agent.dev` | XPC to TalkieAgent |
| Mach | `jdi.talkie.sync.dev` | XPC to TalkieSync |
