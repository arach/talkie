# Context Capture Flow in TalkieAgent
...
perfInAppMs             - TalkieAgent in-app processing time
```
...
2. **Working directory extraction**:
   ...
   - Uses path to generate session ID: `/Users/example/dev/talkie` → `-Users-arach-dev-talkie`
...
3. **Session ID conversion**: `/Users/example/dev/talkie` → `-Users-arach-dev-talkie`
...
**Context capture in TalkieAgent is a two-phase, non-blocking flow:**
